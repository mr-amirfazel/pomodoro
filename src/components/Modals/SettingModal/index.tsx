  ...
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed top-[14vh] left-[20%] w-[60%] z-40 overflow-y-auto bg-yellow-200 rounded-t-md flex flex-col gap-5 p-2">
        ...
        <div className="flex flex-col p-4">
            ...
            <span className="flex items-center justify-evenly">
                    <div className="flex flex-col">
                        <h3>Pomodoro</h3>
                        <input type={"number"} value={state.timer.seconds}></input>
                    </div>
                    <div className="flex flex-col">
                        <h3>Short Break</h3>
                        <input type={"number"} value={state.timer.seconds}></input>
